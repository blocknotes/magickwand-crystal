...
lib LibMagick
  ...
  fun drawGetException = DrawGetException(wand : DrawingWand*, exceptionType : ExceptionType*) : LibC::Char*
  ...
  fun drawGetStrokeDashArray = DrawGetStrokeDashArray(wand : DrawingWand*, s : LibC::SizeT*) : LibC::Double*
  ...
  fun drawComposite = DrawComposite(wand1 : DrawingWand*, compositeOperator : CompositeOperator, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double, d4 : LibC::Double, wand2 : MagickWand*) : Bool
  ...
  fun drawSetClipPath = DrawSetClipPath(wand : DrawingWand*, pc : LibC::Char*) : Bool
  fun drawSetDensity = DrawSetDensity(wand : DrawingWand*, pc : LibC::Char*) : Bool
  fun drawSetFillPatternURL = DrawSetFillPatternURL(wand : DrawingWand*, pc : LibC::Char*) : Bool
  fun drawSetFont = DrawSetFont(wand : DrawingWand*, pc : LibC::Char*) : Bool
  fun drawSetFontFamily = DrawSetFontFamily(wand : DrawingWand*, pc : LibC::Char*) : Bool
  fun drawSetFontResolution = DrawSetFontResolution(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double) : Bool
  fun drawSetStrokeDashArray = DrawSetStrokeDashArray(wand : DrawingWand*, s : LibC::SizeT, dp : LibC::Double*) : Bool
  fun drawSetStrokePatternURL = DrawSetStrokePatternURL(wand : DrawingWand*, pc : LibC::Char*) : Bool
  fun drawSetVectorGraphics = DrawSetVectorGraphics(wand : DrawingWand*, pc : LibC::Char*) : Bool
  ...
  fun drawAffine = DrawAffine(wand : DrawingWand*, affineMatrix : AffineMatrix*) : Void
  # fun drawAlpha  # REMOVED
  #   = DrawAlpha( wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double, paintMethod : PaintMethod ): Void
  fun drawAnnotation = DrawAnnotation(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double, cp : LibC::UChar*) : Void
  fun drawArc = DrawArc(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double, d4 : LibC::Double, d5 : LibC::Double, d6 : LibC::Double) : Void
  fun drawBezier = DrawBezier(wand : DrawingWand*, s : LibC::SizeT, pointInfo : PointInfo*) : Void
  fun drawGetBorderColor = DrawGetBorderColor(wand1 : DrawingWand*, wand2 : PixelWand*) : Void
  fun drawCircle = DrawCircle(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double, d4 : LibC::Double) : Void
  fun drawColor = DrawColor(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double, paintMethod : PaintMethod) : Void
  fun drawComment = DrawComment(wand : DrawingWand*, cp : LibC::Char*) : Void
  fun drawEllipse = DrawEllipse(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double, d4 : LibC::Double, d5 : LibC::Double, d6 : LibC::Double) : Void
  fun drawGetFillColor = DrawGetFillColor(wand1 : DrawingWand*, wand2 : PixelWand*) : Void
  fun drawGetStrokeColor = DrawGetStrokeColor(wand1 : DrawingWand*, wand2 : PixelWand*) : Void
  fun drawSetTextKerning = DrawSetTextKerning(wand : DrawingWand*, d : LibC::Double) : Void
  fun drawSetTextInterlineSpacing = DrawSetTextInterlineSpacing(wand : DrawingWand*, d : LibC::Double) : Void
  ...
  fun drawPathCurveToQuadraticBezierAbsolute = DrawPathCurveToQuadraticBezierAbsolute(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double, d4 : LibC::Double) : Void
  fun drawPathCurveToQuadraticBezierRelative = DrawPathCurveToQuadraticBezierRelative(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double, d4 : LibC::Double) : Void
  fun drawPathCurveToQuadraticBezierSmoothAbsolute = DrawPathCurveToQuadraticBezierSmoothAbsolute(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double) : Void
  ...
  fun drawPathLineToHorizontalAbsolute = DrawPathLineToHorizontalAbsolute(wand : DrawingWand*, d : LibC::Double) : Void
  fun drawPathLineToHorizontalRelative = DrawPathLineToHorizontalRelative(wand : DrawingWand*, d : LibC::Double) : Void
  fun drawPathLineToVerticalAbsolute = DrawPathLineToVerticalAbsolute(wand : DrawingWand*, d : LibC::Double) : Void
  fun drawPathLineToVerticalRelative = DrawPathLineToVerticalRelative(wand : DrawingWand*, d : LibC::Double) : Void
  fun drawPathMoveToAbsolute = DrawPathMoveToAbsolute(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double) : Void
  fun drawPathMoveToRelative = DrawPathMoveToRelative(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double) : Void
  fun drawPathStart = DrawPathStart(wand : DrawingWand*) : Void
  fun drawPoint = DrawPoint(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double) : Void
  fun drawPolygon = DrawPolygon(wand : DrawingWand*, s : LibC::SizeT, pointInfo : PointInfo*) : Void
  fun drawPolyline = DrawPolyline(wand : DrawingWand*, s : LibC::SizeT, pointInfo : PointInfo*) : Void
  fun drawPopClipPath = DrawPopClipPath(wand : DrawingWand*) : Void
  fun drawPopDefs = DrawPopDefs(wand : DrawingWand*) : Void
  fun drawPushClipPath = DrawPushClipPath(wand : DrawingWand*, cp : LibC::Char*) : Void
  fun drawPushDefs = DrawPushDefs(wand : DrawingWand*) : Void
  fun drawRectangle = DrawRectangle(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double, d4 : LibC::Double) : Void
  fun drawResetVectorGraphics = DrawResetVectorGraphics(wand : DrawingWand*) : Void
  fun drawRotate = DrawRotate(wand : DrawingWand*, d : LibC::Double) : Void
  fun drawRoundRectangle = DrawRoundRectangle(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double, d4 : LibC::Double, d5 : LibC::Double, d6 : LibC::Double) : Void
  fun drawScale = DrawScale(wand : DrawingWand*, d1 : LibC::Double, d2 : LibC::Double) : Void
  fun drawSetBorderColor = DrawSetBorderColor(wand1 : DrawingWand*, wand2 : PixelWand*) : Void
  fun drawSetClipRule = DrawSetClipRule(wand : DrawingWand*, fillRule : FillRule) : Void
  fun drawSetClipUnits = DrawSetClipUnits(wand : DrawingWand*, clipPathUnits : ClipPathUnits) : Void
  fun drawSetFillColor = DrawSetFillColor(wand1 : DrawingWand*, wand2 : PixelWand*) : Void
  fun drawSetFillOpacity = DrawSetFillOpacity(wand : DrawingWand*, d : LibC::Double) : Void
  fun drawSetFillRule = DrawSetFillRule(wand : DrawingWand*, fillRule : FillRule) : Void
  fun drawSetFontSize = DrawSetFontSize(wand : DrawingWand*, d : LibC::Double) : Void
  fun drawSetFontStretch = DrawSetFontStretch(wand : DrawingWand*, stretchType : StretchType) : Void
  fun drawSetFontStyle = DrawSetFontStyle(wand : DrawingWand*, styleType : StyleType) : Void
  fun drawSetFontWeight = DrawSetFontWeight(wand : DrawingWand*, s : LibC::SizeT) : Void
  fun drawSetGravity = DrawSetGravity(wand : DrawingWand*, gravityType : GravityType) : Void
  fun drawSetOpacity = DrawSetOpacity(wand : DrawingWand*, d : LibC::Double) : Void
  fun drawSetStrokeAntialias = DrawSetStrokeAntialias(wand : DrawingWand*, b : Bool) : Void
  fun drawSetStrokeColor = DrawSetStrokeColor(wand : DrawingWand*, wand2 : PixelWand*) : Void
  fun drawSetStrokeDashOffset = DrawSetStrokeDashOffset(wand : DrawingWand*, d : LibC::Double) : Void
  ...
  fun drawSetStrokeMiterLimit = DrawSetStrokeMiterLimit(wand : DrawingWand*, s : LibC::SizeT) : Void
  fun drawSetStrokeOpacity = DrawSetStrokeOpacity(wand : DrawingWand*, d : LibC::Double) : Void
  fun drawSetStrokeWidth = DrawSetStrokeWidth(wand : DrawingWand*, d : LibC::Double) : Void
  fun drawSetTextAlignment = DrawSetTextAlignment(wand : DrawingWand*, alignType : AlignType) : Void
  fun drawSetTextAntialias = DrawSetTextAntialias(wand : DrawingWand*, b : Bool) : Void
  fun drawSetTextDecoration = DrawSetTextDecoration(wand : DrawingWand*, decorationType : DecorationType) : Void
