...
lib LibMagick
  ...
  fun magickGetImageProperty = MagickGetImageProperty(wand : MagickWand*, cp : LibC::Char*) : LibC::Char*
  fun magickGetImageProperties = MagickGetImageProperties(wand : MagickWand*, cp : LibC::Char*, sp : LibC::SizeT*) : LibC::Char**
  fun magickGetOption = MagickGetOption(wand : MagickWand*, cp : LibC::Char*) : LibC::Char*
  fun magickGetOptions = MagickGetOptions(wand : MagickWand*, cp : LibC::Char*, sp : LibC::SizeT*) : LibC::Char**
  fun magickQueryConfigureOption = MagickQueryConfigureOption(cp : LibC::Char*) : LibC::Char*
  fun magickQueryConfigureOptions = MagickQueryConfigureOptions(cp : LibC::Char*, sp : LibC::SizeT*) : LibC::Char**
  fun magickQueryFonts = MagickQueryFonts(cp : LibC::Char*, sp : LibC::SizeT*) : LibC::Char**
  fun magickQueryFormats = MagickQueryFormats(cp : LibC::Char*, sp : LibC::SizeT*) : LibC::Char**
  ...
  fun magickGetSamplingFactors = MagickGetSamplingFactors(wand : MagickWand*, sp : LibC::SizeT*) : LibC::Double*
  fun magickQueryFontMetrics = MagickQueryFontMetrics(wand : MagickWand*, wand2 : DrawingWand*, cp : LibC::Char*) : LibC::Double*
  fun magickQueryMultilineFontMetrics = MagickQueryMultilineFontMetrics(wand : MagickWand*, wand2 : DrawingWand*, cp : LibC::Char*) : LibC::Double*
  ...
  fun magickDeleteImageArtifact = MagickDeleteImageArtifact(wand : MagickWand*, cp : LibC::Char*) : Bool
  fun magickDeleteImageProperty = MagickDeleteImageProperty(wand : MagickWand*, cp : LibC::Char*) : Bool
  fun magickDeleteOption = MagickDeleteOption(wand : MagickWand*, cp : LibC::Char*) : Bool
  fun magickGetAntialias = MagickGetAntialias(wand : MagickWand*) : Bool
  fun magickGetPage = MagickGetPage(wand : MagickWand*, sp1 : LibC::SizeT*, sp2 : LibC::SizeT*, ssp1 : LibC::SSizeT*, ssp2 : LibC::SSizeT*) : Bool
  fun magickGetResolution = MagickGetResolution(wand : MagickWand*, dp1 : LibC::Double*, dp2 : LibC::Double*) : Bool
  fun magickGetSize = MagickGetSize(wand : MagickWand*, sp1 : LibC::SizeT*, sp2 : LibC::SizeT*) : Bool
  fun magickGetSizeOffset = MagickGetSizeOffset(wand : MagickWand*, ssp : LibC::SSizeT*) : Bool
  fun magickProfileImage = MagickProfileImage(wand : MagickWand*, cp : LibC::Char*, ptr : Void*, s : LibC::SizeT) : Bool
  fun magickSetAntialias = MagickSetAntialias(wand : MagickWand*, b : Bool) : Bool
  fun magickSetBackgroundColor = MagickSetBackgroundColor(wand : MagickWand*, wand2 : PixelWand*) : Bool
  fun magickSetColorspace = MagickSetColorspace(wand : MagickWand*, colorspaceType : ColorspaceType) : Bool
  fun magickSetCompression = MagickSetCompression(wand : MagickWand*, compressionType : CompressionType) : Bool
  fun magickSetCompressionQuality = MagickSetCompressionQuality(wand : MagickWand*, s : LibC::SizeT) : Bool
  fun magickSetDepth = MagickSetDepth(wand : MagickWand*, s : LibC::SizeT) : Bool
  fun magickSetExtract = MagickSetExtract(wand : MagickWand*, cp : LibC::Char*) : Bool
  fun magickSetFilename = MagickSetFilename(wand : MagickWand*, cp : LibC::Char*) : Bool
  fun magickSetFormat = MagickSetFormat(wand : MagickWand*, cp : LibC::Char*) : Bool
  fun magickSetFont = MagickSetFont(wand : MagickWand*, cp : LibC::Char*) : Bool
  fun magickSetGravity = MagickSetGravity(wand : MagickWand*, gravityType : GravityType) : Bool
  fun magickSetImageArtifact = MagickSetImageArtifact(wand : MagickWand*, cp1 : LibC::Char*, cp2 : LibC::Char*) : Bool
  ...
  fun magickSetPassphrase = MagickSetPassphrase(wand : MagickWand*, cp : LibC::Char*) : Bool
  fun magickSetPointsize = MagickSetPointsize(wand : MagickWand*, d : LibC::Double) : Bool
  ...
  fun magickSetProgressMonitor = MagickSetProgressMonitor(wand : MagickWand*, magickProgressMonitor : MagickProgressMonitor, ptr : Void*) : MagickProgressMonitor
  ...
  fun magickGetOrientationType = MagickGetOrientationType(wand : MagickWand*) : OrientationType
