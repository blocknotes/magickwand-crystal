...
lib LibMagick
  fun acquireKernelInfo = AcquireKernelInfo(cp : LibC::Char*) : KernelInfo*
  fun acquireKernelBuiltIn = AcquireKernelBuiltIn(kernelInfoType : KernelInfoType, geometryInfo : GeometryInfo*) : KernelInfo*
  ...
  fun morphologyImageChannel = MorphologyImageChannel(image : Image*, channelType : ChannelType, morphologyMethod : MorphologyMethod, ss : LibC::SSizeT, kernelInfo : KernelInfo*, exceptionInfo : ExceptionInfo*) : Image*
  ...
  fun showKernelInfo = ShowKernelInfo(kernelInfo : KernelInfo*) : Void
