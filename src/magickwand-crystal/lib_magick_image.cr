...
lib LibMagick
  fun magickGetImageChannelFeatures = MagickGetImageChannelFeatures(wand : MagickWand*, s : LibC::SizeT) : ChannelFeatures*
  fun magickGetImageChannelStatistics = MagickGetImageChannelStatistics(wand : MagickWand*) : ChannelStatistics*
  ...
  # double functions
  fun magickGetImageChannelDistortions = MagickGetImageChannelDistortions(wand1 : MagickWand*, wand2 : MagickWand*, metricType : MetricType) : LibC::Double*
  ...
  fun magickGetImageInterpolateMethod = MagickGetImageInterpolateMethod(wand : MagickWand*) : InterpolatePixelMethod

  # Bool functions
  fun magickAdaptiveBlurImage = MagickAdaptiveBlurImage(wand : MagickWand*, d1 : LibC::Double, d2 : LibC::Double) : Bool
  fun magickAdaptiveBlurImageChannel = MagickAdaptiveBlurImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double) : Bool
  ...
  fun magickAdaptiveSharpenImageChannel = MagickAdaptiveSharpenImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double) : Bool
  fun magickAdaptiveThresholdImage = MagickAdaptiveThresholdImage(wand : MagickWand*, s1 : LibC::SizeT, s2 : LibC::SizeT, ss : LibC::SSizeT) : Bool
  fun magickAddImage = MagickAddImage(wand1 : MagickWand*, wand2 : MagickWand*) : Bool
  fun magickAddNoiseImage = MagickAddNoiseImage(wand : MagickWand*, noiseType : NoiseType) : Bool
  fun magickAddNoiseImageChannel = MagickAddNoiseImageChannel(wand : MagickWand*, channelType : ChannelType, noiseType : NoiseType) : Bool
  ...
  fun magickAutoGammaImageChannel = MagickAutoGammaImageChannel(wand : MagickWand*, channelType : ChannelType) : Bool
  fun magickAutoLevelImage = MagickAutoLevelImage(wand : MagickWand*) : Bool
  fun magickAutoLevelImageChannel = MagickAutoLevelImageChannel(wand : MagickWand*, channelType : ChannelType) : Bool
  ...
  fun magickBlurImageChannel = MagickBlurImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double) : Bool
  fun magickBorderImage = MagickBorderImage(wand : MagickWand*, pixelWand : PixelWand*, s1 : LibC::SizeT, s2 : LibC::SizeT) : Bool
  fun magickBrightnessContrastImage = MagickBrightnessContrastImage(wand : MagickWand*, d1 : LibC::Double, d2 : LibC::Double) : Bool
  fun magickBrightnessContrastImageChannel = MagickBrightnessContrastImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double) : Bool
  ...
  fun magickClampImageChannel = MagickClampImageChannel(wand : MagickWand*, channelType : ChannelType) : Bool
  ...
  fun magickClutImage = MagickClutImage(wand1 : MagickWand*, wand2 : MagickWand*) : Bool
  fun magickClutImageChannel = MagickClutImageChannel(wand1 : MagickWand*, channelType : ChannelType, wand2 : MagickWand*) : Bool
  ...
  fun magickCompositeImage = MagickCompositeImage(wand1 : MagickWand*, wand2 : MagickWand*, compositeOperator : CompositeOperator, ss1 : LibC::SSizeT, ss2 : LibC::SSizeT) : Bool
  fun magickCompositeImageChannel = MagickCompositeImageChannel(wand1 : MagickWand*, channelType : ChannelType, wand2 : MagickWand*, compositeOperator : CompositeOperator, ss1 : LibC::SSizeT, ss2 : LibC::SSizeT) : Bool
  ...
  fun magickContrastStretchImageChannel = MagickContrastStretchImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double) : Bool
  fun magickConvolveImage = MagickConvolveImage(wand : MagickWand*, s : LibC::SizeT, dp : LibC::Double*) : Bool
  fun magickConvolveImageChannel = MagickConvolveImageChannel(wand : MagickWand*, channelType : ChannelType, s : LibC::SizeT, dp : LibC::Double*) : Bool
  ...
  fun magickDistortImage = MagickDistortImage(wand : MagickWand*, distortImageMethod : DistortImageMethod, s : LibC::SizeT, dp : LibC::Double*, b : Bool) : Bool
  ...
  fun magickEqualizeImageChannel = MagickEqualizeImageChannel(wand : MagickWand*, channelType : ChannelType) : Bool
  ...
  fun magickEvaluateImageChannel = MagickEvaluateImageChannel(wand : MagickWand*, channelType : ChannelType, magickEvaluateOperator : MagickEvaluateOperator, d : LibC::Double) : Bool
  ...
  fun magickFilterImage = MagickFilterImage(wand : MagickWand*, kernelInfo : KernelInfo*) : Bool
  fun magickFilterImageChannel = MagickFilterImageChannel(wand : MagickWand*, channelType : ChannelType, kernelInfo : KernelInfo*) : Bool
  fun magickFlipImage = MagickFlipImage(wand : MagickWand*) : Bool
  fun magickFloodfillPaintImage = MagickFloodfillPaintImage(wand : MagickWand*, channelType : ChannelType, pixelWand1 : PixelWand*, d1 : LibC::Double, pixelWand2 : PixelWand*, ss1 : LibC::SSizeT, ss2 : LibC::SSizeT, b : Bool) : Bool
  ...
  fun magickFrameImage = MagickFrameImage(wand : MagickWand*, pixelWand : PixelWand*, s1 : LibC::SizeT, s2 : LibC::SizeT, ss1 : LibC::SSizeT, ss2 : LibC::SSizeT) : Bool
  ...
  fun magickFunctionImageChannel = MagickFunctionImageChannel(wand : MagickWand*, channelType : ChannelType, magickFunction : MagickFunction, s : LibC::SizeT, dp : LibC::Double*) : Bool
  fun magickGammaImage = MagickGammaImage(wand : MagickWand*, d : LibC::Double) : Bool
  fun magickGammaImageChannel = MagickGammaImageChannel(wand : MagickWand*, channelType : ChannelType, d : LibC::Double) : Bool
  fun magickGaussianBlurImage = MagickGaussianBlurImage(wand : MagickWand*, d1 : LibC::Double, d2 : LibC::Double) : Bool
  fun magickGaussianBlurImageChannel = MagickGaussianBlurImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double) : Bool
  ...
  fun magickGetImageBluePrimary = MagickGetImageBluePrimary(wand : MagickWand*, dp1 : LibC::Double*, dp2 : LibC::Double*) : Bool
  fun magickGetImageBorderColor = MagickGetImageBorderColor(wand : MagickWand*, pixelWand : PixelWand*) : Bool
  fun magickGetImageChannelDistortion = MagickGetImageChannelDistortion(wand1 : MagickWand*, wand2 : MagickWand*, channelType : ChannelType, metricType : MetricType, dp : LibC::Double*) : Bool
  fun magickGetImageChannelKurtosis = MagickGetImageChannelKurtosis(wand : MagickWand*, channelType : ChannelType, dp1 : LibC::Double*, dp2 : LibC::Double*) : Bool
  fun magickGetImageChannelMean = MagickGetImageChannelMean(wand : MagickWand*, channelType : ChannelType, dp1 : LibC::Double*, dp2 : LibC::Double*) : Bool
  fun magickGetImageChannelRange = MagickGetImageChannelRange(wand : MagickWand*, channelType : ChannelType, dp1 : LibC::Double*, dp2 : LibC::Double*) : Bool
  ...
  fun magickGetImageGreenPrimary = MagickGetImageGreenPrimary(wand : MagickWand*, dp1 : LibC::Double*, dp2 : LibC::Double*) : Bool
  ...
  fun magickGetImageRedPrimary = MagickGetImageRedPrimary(wand : MagickWand*, dp1 : LibC::Double*, dp2 : LibC::Double*) : Bool
  fun magickGetImageResolution = MagickGetImageResolution(wand : MagickWand*, dp1 : LibC::Double*, dp2 : LibC::Double*) : Bool
  fun magickGetImageWhitePoint = MagickGetImageWhitePoint(wand : MagickWand*, dp1 : LibC::Double*, dp2 : LibC::Double*) : Bool
  fun magickHaldClutImage = MagickHaldClutImage(wand1 : MagickWand*, wand2 : MagickWand*) : Bool
  fun magickHaldClutImageChannel = MagickHaldClutImageChannel(wand1 : MagickWand*, channelType : ChannelType, wand2 : MagickWand*) : Bool
  ...
  fun magickImplodeImage = MagickImplodeImage(wand : MagickWand*, d : LibC::Double) : Bool
  ...
  fun magickLevelImageChannel = MagickLevelImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double) : Bool
  ...
  fun magickMedianFilterImage = MagickMedianFilterImage(wand : MagickWand*, d : LibC::Double) : Bool
  ...
  fun magickMorphologyImageChannel = MagickMorphologyImageChannel(wand : MagickWand*, channelType : ChannelType, morphologyMethod : MorphologyMethod, ss : LibC::SSizeT, kernelInfo : KernelInfo*) : Bool
  fun magickMotionBlurImage = MagickMotionBlurImage(wand : MagickWand*, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double) : Bool
  fun magickMotionBlurImageChannel = MagickMotionBlurImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double) : Bool
  fun magickNegateImage = MagickNegateImage(wand : MagickWand*, b : Bool) : Bool
  fun magickNegateImageChannel = MagickNegateImageChannel(wand : MagickWand*, channelType : ChannelType, b : Bool) : Bool
  ...
  fun magickNormalizeImageChannel = MagickNormalizeImageChannel(wand : MagickWand*, channelType : ChannelType) : Bool
  fun magickOilPaintImage = MagickOilPaintImage(wand : MagickWand*, d : LibC::Double) : Bool
  ...
  fun magickOpaquePaintImageChannel = MagickOpaquePaintImageChannel(wand : MagickWand*, channelType : ChannelType, pixelWand1 : PixelWand*, pixelWand2 : PixelWand*, d : LibC::Double, b : Bool) : Bool
  fun magickOrderedPosterizeImage = MagickOrderedPosterizeImage(wand : MagickWand*, pc : LibC::Char*) : Bool
  fun magickOrderedPosterizeImageChannel = MagickOrderedPosterizeImageChannel(wand : MagickWand*, channelType : ChannelType, pc : LibC::Char*) : Bool
  ...
  fun magickPolaroidImage = MagickPolaroidImage(wand : MagickWand*, drawingWand : DrawingWand*, d : LibC::Double) : Bool
  fun magickPosterizeImage = MagickPosterizeImage(wand : MagickWand*, s : LibC::SizeT, b : Bool) : Bool
  fun magickPreviousImage = MagickPreviousImage(wand : MagickWand*) : Bool
  fun magickQuantizeImage = MagickQuantizeImage(wand : MagickWand*, s1 : LibC::SizeT, colorspaceType : ColorspaceType, s2 : LibC::SizeT, b1 : Bool, b2 : Bool) : Bool
  fun magickQuantizeImages = MagickQuantizeImages(wand : MagickWand*, s1 : LibC::SizeT, colorspaceType : ColorspaceType, s2 : LibC::SizeT, b1 : Bool, b2 : Bool) : Bool
  ...
  fun magickRandomThresholdImageChannel = MagickRandomThresholdImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double) : Bool
  ...
  fun magickResampleImage = MagickResampleImage(wand : MagickWand*, d1 : LibC::Double, d2 : LibC::Double, filterTypes : FilterTypes, d3 : LibC::Double) : Bool
  fun magickResetImagePage = MagickResetImagePage(wand : MagickWand*, pc : LibC::Char*) : Bool
  fun magickResizeImage = MagickResizeImage(wand : MagickWand*, s1 : LibC::SizeT, s2 : LibC::SizeT, filterTypes : FilterTypes, d : LibC::Double) : Bool
  ...
  fun magickRotationalBlurImageChannel = MagickRotationalBlurImageChannel(wand : MagickWand*, channelType : ChannelType, d : LibC::Double) : Bool
  ...
  fun magickSelectiveBlurImageChannel = MagickSelectiveBlurImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double) : Bool
  fun magickSeparateImageChannel = MagickSeparateImageChannel(wand : MagickWand*, channelType : ChannelType) : Bool
  ...
  fun magickSetImageAlphaChannel = MagickSetImageAlphaChannel(wand : MagickWand*, alphaChannelType : AlphaChannelType) : Bool
  fun magickSetImageBackgroundColor = MagickSetImageBackgroundColor(wand : MagickWand*, pixelWand : PixelWand*) : Bool
  fun magickSetImageBias = MagickSetImageBias(wand : MagickWand*, d : LibC::Double) : Bool
  fun magickSetImageBluePrimary = MagickSetImageBluePrimary(wand : MagickWand*, d1 : LibC::Double, d2 : LibC::Double) : Bool
  fun magickSetImageBorderColor = MagickSetImageBorderColor(wand : MagickWand*, pixelWand : PixelWand*) : Bool
  fun magickSetImageChannelDepth = MagickSetImageChannelDepth(wand : MagickWand*, channelType : ChannelType, s : LibC::SizeT) : Bool
  fun magickSetImageClipMask = MagickSetImageClipMask(wand1 : MagickWand*, wand2 : MagickWand*) : Bool
  ...
  fun magickSetImageGreenPrimary = MagickSetImageGreenPrimary(wand : MagickWand*, d1 : LibC::Double, d2 : LibC::Double) : Bool
  fun magickSetImageInterlaceScheme = MagickSetImageInterlaceScheme(wand : MagickWand*, interlaceType : InterlaceType) : Bool
  fun magickSetImageInterpolateMethod = MagickSetImageInterpolateMethod(wand : MagickWand*, interpolatePixelMethod : InterpolatePixelMethod) : Bool
  ...
  fun magickSetImageOpacity = MagickSetImageOpacity(wand : MagickWand*, d : LibC::Double) : Bool
  ...
  fun magickSetImageRedPrimary = MagickSetImageRedPrimary(wand : MagickWand*, d1 : LibC::Double, d2 : LibC::Double) : Bool
  ...
  fun magickSetImageWhitePoint = MagickSetImageWhitePoint(wand : MagickWand*, d1 : LibC::Double, d2 : LibC::Double) : Bool
  ...
  fun magickSharpenImageChannel = MagickSharpenImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double) : Bool
  ...
  fun magickSigmoidalContrastImageChannel = MagickSigmoidalContrastImageChannel(wand : MagickWand*, channelType : ChannelType, b : Bool, d1 : LibC::Double, d2 : LibC::Double) : Bool
  ...
  fun magickSolarizeImageChannel = MagickSolarizeImageChannel(wand : MagickWand*, channelType : ChannelType, d : LibC::Double) : Bool
  fun magickSparseColorImage = MagickSparseColorImage(wand : MagickWand*, channelType : ChannelType, sparseColorMethod : SparseColorMethod, s : LibC::SizeT, dp : LibC::Double*) : Bool
  fun magickSpliceImage = MagickSpliceImage(wand : MagickWand*, s1 : LibC::SizeT, s2 : LibC::SizeT, ss1 : LibC::SSizeT, ss2 : LibC::SSizeT) : Bool
  fun magickSpreadImage = MagickSpreadImage(wand : MagickWand*, d : LibC::Double) : Bool
  ...
  fun magickStatisticImageChannel = MagickStatisticImageChannel(wand : MagickWand*, channelType : ChannelType, statisticType : StatisticType, s1 : LibC::SizeT, s2 : LibC::SizeT) : Bool
  fun magickStripImage = MagickStripImage(wand : MagickWand*) : Bool
  fun magickSwirlImage = MagickSwirlImage(wand : MagickWand*, d : LibC::Double) : Bool
  ...
  fun magickThresholdImageChannel = MagickThresholdImageChannel(wand : MagickWand*, channelType : ChannelType, d : LibC::Double) : Bool
  ...
  fun magickUnsharpMaskImageChannel = MagickUnsharpMaskImageChannel(wand : MagickWand*, channelType : ChannelType, d1 : LibC::Double, d2 : LibC::Double, d3 : LibC::Double, d4 : LibC::Double) : Bool
  ...
  fun magickWaveImage = MagickWaveImage(wand : MagickWand*, d1 : LibC::Double, d2 : LibC::Double) : Bool
  ...
  fun magickCombineImages = MagickCombineImages(wand : MagickWand*, channelType : ChannelType) : MagickWand*
  fun magickCompareImageChannels = MagickCompareImageChannels(wand1 : MagickWand*, wand2 : MagickWand*, channelType : ChannelType, metricType : MetricType, dp : LibC::Double*) : MagickWand*
  ...
  fun magickCompareImageLayers = MagickCompareImageLayers(wand : MagickWand*, imageLayerMethod : ImageLayerMethod) : MagickWand*
  ...
  fun magickFxImageChannel = MagickFxImageChannel(wand : MagickWand*, channelType : ChannelType, cp : LibC::Char*) : MagickWand*
  fun magickGetImage = MagickGetImage(wand : MagickWand*) : MagickWand*
  fun magickGetImageClipMask = MagickGetImageClipMask(wand : MagickWand*) : MagickWand*
  ...
  fun magickMergeImageLayers = MagickMergeImageLayers(wand : MagickWand*, imageLayerMethod : ImageLayerMethod) : MagickWand*
  ...
  fun magickSimilarityImage = MagickSimilarityImage(wand1 : MagickWand*, wand2 : MagickWand*, rectangleInfo : RectangleInfo*, dp : LibC::Double*) : MagickWand*
  ...
  fun magickTransformImage = MagickTransformImage(wand : MagickWand*, cp1 : LibC::Char*, cp2 : LibC::Char*) : MagickWand*
  ...
  fun magickGetImageChannelDepth = MagickGetImageChannelDepth(wand : MagickWand*, channelType : ChannelType) : LibC::SizeT
